...
namespace UIJobsAPI.Exceptions
{
    public class BaseException : Exception
    {
        ...
        public BaseException(string errorCode, string message, HttpStatusCode httpStatusCode, int statusCode, DateTimeOffset timestamp, Exception? ex) : base(message, ex)
        {
